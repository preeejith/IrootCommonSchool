...
//     final List<DateTime> ? prensentdays;
              ...
              Expanded(
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    bool isHoliday = widget.holidays.any((h) =>
                        h.year == year && h.month == month && h.day == day);
                    bool isLeave = widget.leaves != null &&
                        widget.leaves!.any((l) =>
                            l.year == year && l.month == month && l.day == day);
                    bool isPresent = widget.prensentdays != null &&
                        widget.prensentdays!.any((p) =>
                    ...
                    return Center(
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          color: isPresent
                              ? const Color.fromARGB(255, 176, 233, 126)
                              : isLeave
                                  ? const Color.fromARGB(255, 145, 94, 233)
                                  : isHoliday
                                      ? Color.fromARGB(255, 127, 220, 130)
                                      : isSunday
                                          ? Color.fromARGB(159, 227, 157, 241)
