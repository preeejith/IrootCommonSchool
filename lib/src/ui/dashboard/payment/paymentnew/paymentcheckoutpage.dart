...
//     // Transaction details
//     String plainText =
//         "merchantId=$merchantId|txnAmount=${widget.txnAmount}|txnCurrency=INR|orderId=${widget.orderId}|returnUrl=https://nirmalaapi.lumensof.in/api/Paymet/api/payment/capture-response";
