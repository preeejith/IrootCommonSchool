...
class _PaymentWebViewState extends State<PaymentWebView> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        //             "merchId": "628856",
        //  "returnUrl": "https://stmarysschool.lumensof.in/Payment/CapturePaymentReponse",
        body: Stack(
          children: [
            InAppWebView(
              initialData: InAppWebViewInitialData(
                ...
                if (url != null &&
                  ...
                  if (response.trim().contains("cancelTransaction")) {
                    ...
                    await callCaptureResponseApi(
                        ...
                        responseData: splitTwo[1].toString());
  ...
  Future<void> callCaptureResponseApi(
      {required String status, dynamic responseData}) async {
    final uri = Uri.parse(
        "https://stmarysschool.lumensof.in/api/Paymet/api/payment/capture-response");
    ...
    // Convert responseData if it's a JSON string
    if (responseData is String) {
      try {
        ...
        debugPrint("Error parsing responseData: $e");
        return;
      }
    }

    // Handle responseData as a map
    if (responseData is Map<String, dynamic>) {
      responseData.forEach((key, value) {
