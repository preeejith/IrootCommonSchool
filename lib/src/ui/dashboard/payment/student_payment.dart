...
class _PaymentScreenState extends State<PaymentScreen> {
  @override
  void initState() {
    context.read<MainBloc>().totalfeeamount = 0;
    // context.read<MainBloc>().studentFeeListModel.totalAmount = 0;
                    ...
                    child: Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: customOutlinedButton(
                          ...
                          if (context.read<MainBloc>().totalfeeamount == 0) {
                            Fluttertoast.showToast(
                                msg: "please select payment to continue");
                          } else {
