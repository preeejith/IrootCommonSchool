...
import 'package:iroots/src/ui/dashboard/student/home/statichome.dart';
                      ...
                      builder: (context, state) {
                        return Column(
                          ...
                          children: [
                            ...
                            //Roll No: ${context.read<MainBloc>().studentrollnumber == null ? "" : context.read<MainBloc>().studentrollnumber.toString()
                            AppUtil.customText(
                              text:
                                  "${context.read<MainBloc>().studentclass == null ? "Class-" : context.read<MainBloc>().studentclass.toString()}  Section : ${context.read<MainBloc>().studentSection == null ? "" : context.read<MainBloc>().studentSection.toString()} ",
                              style: const TextStyle(
                                  fontFamily: 'Open Sans',
                                  fontWeight: FontWeight.w600,
                                  color: Colors.white,
              ...
              Row(
                ...
                children: [
                  ...
                  BlocBuilder<MainBloc, MainState>(
                    builder: (context, state) {
                      double attpercent =
                          context.read<MainBloc>().attendancepercentage;
                      return
                          // Text(context
                          //     .read<MainBloc>()
                          ...
                          context
                              ...
                              : context.read<MainBloc>().attendancepercentage >
                                  ...
                                  : CircularPercentIndicator(
                                      ...
                                      lineWidth:
                                          12.0, // Thickness of the progress line
                                      percent:
                                          attpercent, // Value between 0.0 to 1.0
                                      center: Text(
                                        "${(attpercent * 100).toStringAsFixed(1)}%",
                                        style: TextStyle(
                                            fontSize: 20,
