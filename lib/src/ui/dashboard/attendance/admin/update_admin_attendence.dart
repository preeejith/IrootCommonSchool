...
import 'package:iroots/src/controller/attendance/admin/update_admin_attendance_controller.dart';
import 'package:iroots/src/utility/const.dart';
import 'package:iroots/src/utility/util.dart';

class UpdateAdminAttendanceScreen extends StatelessWidget {
  const UpdateAdminAttendanceScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
      init: UpdateAdminAttendanceController(),
              ...
              child: Column(
                ...
                children: [
                  AppUtil.customDropDown(
                      ...
                      "Select Staff",
                      "Please Select Staff",
                      logic.dashBoardController.adminStaffDataList, (newValue) {
                  ...
                  AppUtil.customDropDown1("Select Section", logic.sectionName),
                  const SizedBox(
                    height: 10,
                  ),
                  AppUtil.customText(
