...
//                   children: [
//                     AppUtil.customText(
//                       text: selectedValue ?? "Select Section",
//                       style: TextStyle(
...
//                 ),
//               ),
//               () => _showDropdownPopup(context!, itemList, onChanged),
//             ),
//           ),
//         ],
//       ),
...
// // Helper method for custom popup
...
// import 'package:iroots/src/controller/home/staff/staff_home_controller.dart';
// import 'package:iroots/src/modal/home/staff/staffDetails.dart';
// import 'update_staff_attendence.dart';
// import 'view_attendence.dart';
// import 'package:iroots/src/utility/const.dart';
// import 'package:iroots/src/utility/util.dart';
...
//                     const SizedBox(height: 10),
//                     Obx(() {
//                       // Set default section based on class teacher status
//                       if (logic.selectedSection.value.isEmpty) {
//                         String defaultSection = logic.staffHomeWorkController
//                                     .isclassteacherany ==
//                                 false
//                             ? ""
//                             : logic.staffHomeWorkController.staffClassmodel
...
//                                     ""
//                                 : "";
//                         logic.selectedSection.value = defaultSection;
//                       }
...
//                               null) {
//                             try {
//                               final sectionData = logic.staffHomeWorkController
//                                   .staffClassmodel!.data!
//                                   .firstWhere(
//                                       (item) => item.section == selectedValue);
...
//                 ),
//               ),
//               () => _showDropdownPopup(context!, title!, itemList, onChanged),
//             ),
//           ),
//         ],
//       ),
...
//                     ),
//                     onTap: () {
//                       String selectedValue = title.contains("Class")
//                           ? (item.dataListItemName ?? "")
//                           : (item.section ?? "");
...
//                               // Or refresh the specific observable that should trigger UI update
//                               logic.selectedClass.refresh();
//                             } catch (e) {
//                               logic.selectedClassId.value = '';
//                             }
//                           }
...
import 'package:iroots/src/controller/home/staff/staff_home_controller.dart';
import 'package:iroots/src/modal/home/staff/staffDetails.dart';
import 'package:iroots/src/ui/dashboard/attendance/staff/studentprofilelist/updatenewstaffattendance.dart';
import 'update_staff_attendence.dart';
import 'view_attendence.dart';
import 'package:iroots/src/utility/const.dart';
import 'package:iroots/src/utility/util.dart';
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: customOutlinedButton(
                        ...
                        // Get.to(() => StaffUpdateAttendanceScreen());
                        if (logic.staffHomeWorkController.isclassteacherany ==
                            false) {
                          Fluttertoast.showToast(
                              msg:
