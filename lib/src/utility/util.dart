...
import 'package:iroots/src/modal/attendance/new/adminstaffmodel.dart';
...
class AppUtil {
  ...
  static customDropDown(
      ...
      String? dropDownText,
      String? hintText,
      // AdminStaffListModel adminStaffListModel,
    ...
    return Column(
      ...
      children: [
        ...
        // DropdownButtonFormField<AdminStaffListModel>(
        //   icon: SvgPicture.asset(
        //     "assets/icons/arrowdown_icon.svg",
        //     height: 20,
        //     width: 20,
        //   ),
        //   value: value,
        //   items: adminStaffListModel.data!.map((item) {
        //     return DropdownMenuItem<AdminStaffListModel>(
        //         value: item.date,
        //         child: item.name!.isNotEmpty && item.name != ""
        //             ? AppUtil.customText(
        //                 text: item.name,
        //                 style: TextStyle(
        //                     color: const Color(0xff0F172A),
...
//    DropdownButtonFormField<Data>(  // Changed from StaffData to Data
//   icon: SvgPicture.asset(
//     "assets/icons/arrowdown_icon.svg",
//     height: 20,
//     width: 20,
//   ),
//   value: value!,  // Make sure this is also of type Data?
//   items: adminStaffListModel.data!.map((item) {
//     return DropdownMenuItem<Data>(  // Changed from StaffData to Data
//         value: item,
//         child: item.name!.isNotEmpty && item.name != ""
//             ? AppUtil.customText(
//                 text: item.name,
...
//   }).toList(),
//   onChanged: (newValue) {
//     onChanged(newValue);  // Make sure onChanged parameter accepts Data?
//   },
//   decoration: InputDecoration(
//     contentPadding: const EdgeInsets.all(10),
//     hintText: hintText,
