...
class ServerHelper {
  ...
  static String merchentId = "625002";
  static String hashrequeskey = "f22fbd7fac2b5db1c8";
  static String merchPass = "35c9ea61";
  //payment

  static String myschoolauth = "nirmala_";

  static String baseUrlOhyes = "https://nirmalaapi.lumensof.in/api/";
  // static const baseUrlOhyes =

  //MyQpadServer
  static const baseUrl = "https://nirmalaapi.lumensof.in/api/";
